...
function strassen_modified(A, B)
    ...
    S1 = A11 + A22
    S2 = B11 + B22
    P1 = strassen_multiply(S1, S2)
    S3 = A21 + A22
    P2 = strassen_multiply(S3, B11)
    S4 = A11
    P3 = strassen_multiply(S4, B12 - B22)
    S5 = A22
    P4 = strassen_multiply(S5, B21 - B11)
    S6 = A11 + A12
    P5 = strassen_multiply(S6, B22)
    S7 = A21 - A11
    P6 = strassen_multiply(S7, B11 + B12)
    S8 = A12 - A22
    P7 = strassen_multiply(S8, B21 + B22)
...
function strassen_modified2(A, B)
    ...
    @threads for i in 1:7
        if i == 1
            P[1] = strassen_multiply2(S1, S2)
        elseif i == 2
            P[2] = strassen_multiply2(S3, B11)
        elseif i == 3
            P[3] = strassen_multiply2(S4, B12 - B22)
        elseif i == 4
            P[4] = strassen_multiply2(S5, B21 - B11)
        elseif i == 5
            P[5] = strassen_multiply2(S6, B22)
        elseif i == 6
            P[6] = strassen_multiply2(S7, B11 + B12)
        elseif i == 7
            P[7] = strassen_multiply2(S8, B21 + B22)
        end
    end
