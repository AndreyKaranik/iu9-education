...
Реализовать и сравнить метод Карацубы с традиционным методом умножения больших чисел.
...
В ходе выполнения данной работы было выявлено, что метод Карацубы эффективнее для больших чисел, но в реализации на Julia его производительность ниже стандартного метода для малых чисел.