...
name: "Параллельный ГА"
number: "15"
---

# Цель работы

Разработка и сравнение параллельного и последовательного генетических алгоритмов (ГА) для оптимизации функции Розенброка с целью ускорения сходимости и улучшения качества решения за счёт параллельных вычислений и миграции особей между подпопуляциями.
...
Параллельный генетический алгоритм с миграцией особей между подпопуляциями демонстрирует более быстрое достижение оптимального решения по сравнению с последовательной версией. Реализация на Julia с использованием многопоточности и WebSocket-коммуникации подтверждает эффективность параллельного подхода для сложных оптимизационных задач.