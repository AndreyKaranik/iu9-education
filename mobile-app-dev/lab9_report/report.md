...
name: "Поиск экстремума функции методом покоординатного спуска"
number: "9"
---
...
В ходе выполнения лабораторной работы был успешно реализован метод покоординатного спуска с визуализацией в Flutter. Приложение позволяет изменять параметры функции, что наглядно демонстрирует процесс нахождения минимума и особенности поведения метода на квадратичных функциях.